...
<head>
    ...
    <!-- ajax spinner -->
    <link href="{{ asset('css/common/ajax-spinner.css') }}" rel="stylesheet">
...
<body>
    <div id="app">
        ...
        <div role="alert" aria-live="assertive" aria-atomic="true" class="toast" data-autohide="true" data-animation="true" data-delay="500">
